...
description: Copy and optimize the free AI prompt for: "Claude Code Statusline Design".
...
> Copy and optimize the free AI prompt for: "Claude Code Statusline Design".
