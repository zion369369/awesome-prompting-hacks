...
description: Copy and optimize the free AI prompt for: "Test-First Bug Fixing Approach".
...
> Copy and optimize the free AI prompt for: "Test-First Bug Fixing Approach".
