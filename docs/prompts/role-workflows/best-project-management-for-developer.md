# 🏆 Prompt Template: Best PROJECT-MANAGEMENT Platforms for developer
...
*   **Product Type**: project-management
...
```text
"Act as a professional software auditor. Analyze the best project-management suites specifically matching user workflow requirements for developer."
```
