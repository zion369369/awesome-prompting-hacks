# 🏆 Prompt Template: Best CRM Platforms for developer
...
```text
"Act as a professional software auditor. Analyze the best crm suites specifically matching user workflow requirements for developer."
```
