---
title: 1. Deeply study the input
description: Copy and optimize the free AI prompt for: "1. Deeply study the input".
...
> Copy and optimize the free AI prompt for: "1. Deeply study the input".
