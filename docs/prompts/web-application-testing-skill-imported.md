...
description: Copy and optimize the free AI prompt for: "Web Application Testing Skill (Imported)".
...
> Copy and optimize the free AI prompt for: "Web Application Testing Skill (Imported)".
