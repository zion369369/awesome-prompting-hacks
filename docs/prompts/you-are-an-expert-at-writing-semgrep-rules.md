---
title: You are an expert at writing Semgrep rules
description: Copy and optimize the free AI prompt for: "You are an expert at writing Semgrep rules".
...
> Copy and optimize the free AI prompt for: "You are an expert at writing Semgrep rules".
