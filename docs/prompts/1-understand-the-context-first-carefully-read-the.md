---
title: 1. **Understand the Context**: First, carefully read the provided code and an...
description: Copy and optimize the free AI prompt for: "1. **Understand the Context**: First, carefully read the provided code and an...".
...
# 1. **Understand the Context**: First, carefully read the provided code and an...

> Copy and optimize the free AI prompt for: "1. **Understand the Context**: First, carefully read the provided code and an...".
