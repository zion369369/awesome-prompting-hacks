...
description: Copy and optimize the free AI prompt for: "Text-to-Image with Reference - Billiards Bar Scene".
...
> Copy and optimize the free AI prompt for: "Text-to-Image with Reference - Billiards Bar Scene".
