...
description: Copy and optimize the free AI prompt for: "Comprehensive Go Codebase Review - Forensic-Level Analysis Prompt".
...
> Copy and optimize the free AI prompt for: "Comprehensive Go Codebase Review - Forensic-Level Analysis Prompt".
