...
description: Copy and optimize the free AI prompt for: "Nano Banana Pro Prompt Generator Instruction (Outputs JSON blocks like these)".
...
> Copy and optimize the free AI prompt for: "Nano Banana Pro Prompt Generator Instruction (Outputs JSON blocks like these)".
