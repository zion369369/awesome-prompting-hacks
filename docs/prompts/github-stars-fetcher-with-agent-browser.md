...
description: Copy and optimize the free AI prompt for: "GitHub Stars Fetcher with Agent Browser".
...
> Copy and optimize the free AI prompt for: "GitHub Stars Fetcher with Agent Browser".
