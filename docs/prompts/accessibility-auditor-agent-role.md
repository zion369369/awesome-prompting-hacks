...
description: Copy and optimize the free AI prompt for: "Accessibility Auditor Agent Role".
...
> Copy and optimize the free AI prompt for: "Accessibility Auditor Agent Role".
