...
description: Copy and optimize the free AI prompt for: "Developer Work Analysis from Git Diff and Commit Message".
...
> Copy and optimize the free AI prompt for: "Developer Work Analysis from Git Diff and Commit Message".
