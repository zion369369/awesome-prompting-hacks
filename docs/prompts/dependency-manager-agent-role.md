...
description: Copy and optimize the free AI prompt for: "Dependency Manager Agent Role".
...
> Copy and optimize the free AI prompt for: "Dependency Manager Agent Role".
